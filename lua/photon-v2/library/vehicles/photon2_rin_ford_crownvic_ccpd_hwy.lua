...
VEHICLE.Title 		= "2010 Ford Crown Victoria CCPD HWY"
...
VEHICLE.Equipment = {
	{
		...
		Options = {
			
			{
				Option = "Patrol",
				SubMaterials = {
					{ Id = 3, Material = "rin/creamer/crownvic10/highway" }
				}
			},
		}
	},
				...
				Components = {
					{
						...
						Bones = {
							["foot_l"] = { Vector( -9, 0, -0.2), Angle( 0, 0, 0 ), 1 },
							["foot_r"] = { Vector( 9, 0, -0.2), Angle( 0, 0, 0 ), 1 },
